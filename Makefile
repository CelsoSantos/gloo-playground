...
define display_help_message
	...
	@echo "  $(ccpink)server$(ccend)  - build the gRPC server component"
	@echo "  $(ccpink)cli$(ccend)     - build the gRPC client component"
	@echo "  $(ccpink)addin$(ccend)   - build the MS Word add-in component"
	@echo ""
...
server: not_in_sandbox
	@echo "$(ccred)[WARN]$(ccend) Building gRPC Server component ..."
	$(call build_server)

cli: not_in_sandbox
	@echo "$(ccred)[WARN]$(ccend) Building gRPC Client component ..."
	$(call build_cli)

addin: not_in_sandbox
	@echo "$(ccred)[WARN]$(ccend) Building MS Word Add-in component ..."
	$(call build_addin)